...
const TIERS: { id: WatchdogTier; label: string; cadence: string; description: string }[] = [
  ...
  { id: "deep_verify",        label: "Deep verify",     cadence: "every 6 hours", description: "Anthropic + OpenAI + ChromaDB liveness" },
  ...
  return (
    <div className="space-y-6 max-w-7xl">
      ...
      <section className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <div className="rounded border bg-white p-3">
          <div className="text-xs text-slate-500 uppercase">ChromaDB</div>
          <div className="mt-2 flex items-center gap-3"><StatusDot ok={!!state?.chroma_alive} /><span className="text-sm">{state?.chroma_alive ? "Reachable" : "Unverified"}</span></div>
        </div>
        <div className="rounded border bg-white p-3">
